...
### AI Chat Profile
Special extraction mode for AI conversations (Codex, ChatGPT, Gemini). Site-specific selectors configured in `ai-chat-config.js`. Extracts user/assistant messages as Obsidian callout blocks.
