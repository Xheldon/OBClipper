const messages = {
  en: {
    ...
    "ai.siteSelectors": "Site Selectors",
    "ai.titleSelector": "Title",
    "ai.userSelector": "User message",
    "ai.assistantSelector": "AI response",
    "ai.userStripSelector": "Strip from user msg (CSS selector)",
  ...
  zh: {
    ...
    "ai.siteSelectors": "站点选择器",
    "ai.titleSelector": "标题",
    "ai.userSelector": "用户消息",
    "ai.assistantSelector": "AI 回答",
    "ai.userStripSelector": "用户消息剥离元素（CSS 选择器）",
