const messages = {
  en: {
    ...
    "autolink.toggle": "Enable",
    "autolink.desc": "Auto-link vault filenames in clipped content (first occurrence only)",
  ...
  zh: {
    ...
    "autolink.title": "自动双链",
    "autolink.toggle": "启用",
    "autolink.desc": "将在剪藏内容中与 Vault 中同名的文件识别为双链插入（仅每个文件名首次遇到）",
